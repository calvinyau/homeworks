...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("cookie", "hello", chef) }.to raise_error(ArgumentError)
    end
  end

  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      expect(cookie.ingredients).to_not include("dough")
      cookie.add_ingredient("dough")
      expect(cookie.ingredients).to include("dough")
    end
  end

  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["dough", "chocolate chips", "egg", "sugar"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(cookie.serve).to include("Chef Bob")
    end
  end
